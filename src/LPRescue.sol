...
contract LPRescue is ReentrancyGuard {
        ...
        returns (uint256 amountAActual, uint256 amountBActual, uint256 liquidity)
    {
        ...
        // return values
        (amountAActual, amountBActual) =
            tokenA == token0 ? (amount0Actual, amount1Actual) : (amount1Actual, amount0Actual);
     ...
     */
    function checkPairAndInputs(IDexPair pair, address token0, address token1, uint256 amount0, uint256 amount1)
        internal
